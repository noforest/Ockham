...
Backend failures and unreadable replies are excluded from the accuracy figures and
reported on their own; the cost figures cover every sample.
"""
...
def _pairwise(df):
    """P-C/P-V/P-B/P-R, paired by pair_id, never by cve.
